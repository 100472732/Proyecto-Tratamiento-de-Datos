...
Las redes neuronales alimenatadas con datos fijos (estáticos) no logran superar el umbral de 0.05-0.07 que marca el modelo lineal (Ridge). Necesitamos fine tuning.
